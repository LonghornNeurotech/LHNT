...
//     >
//       <div 
//         className="bg-white rounded-lg w-[90vw] h-[90vh] p-6 flex flex-col overflow-auto"
//         onClick={(e) => e.stopPropagation()}
//       >
//         {/* Header */}
//         <div className="flex justify-between items-center mb-4">
//           <h2 className="text-xl font-semibold flex-1 line-clamp-2">
//             {video.title}
//           </h2>
//           <button 
//             onClick={onClose}
...
//               <p className="mb-4">Video unavailable in modal</p>
//               <button
//                 onClick={() => onEmbedError?.(video)}
