...
const Login = () => {
  ...
  return (
    <div className="bg-[#213C58] min-h-screen flex items-center justify-center">
      <div className="bg-white rounded-lg shadow-lg p-8 w-full max-w-md mx-auto" style={{borderRadius: '10px'}}>
        <h2 className="text-center text-2xl font-bold mb-6 heading">Login</h2>
        <form onSubmit={handleSubmit} className="mx-auto">
          <div className="mb-4">
            <label
              htmlFor="username"
              className="block text-sm font-medium text-[#213C58] mb-2 subheading"
            >
              Username
            </label>
            <input
            ...
            />
            {errors.username && (
              <p className="text-red-500 text-sm mt-1 subheading">{errors.username}</p>
            )}
          </div>
          <div className="mb-4">
            <label
            ...
            />
            {errors.password && (
              <p className="text-red-500 text-sm mt-1 subheading">{errors.password}</p>
            )}
          </div>
          <button
            type="submit"
